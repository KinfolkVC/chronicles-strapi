...
export interface ApiFounderFounder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    emailTitle: Schema.Attribute.Text & Schema.Attribute.Unique;
    ...
    spotifyUrl: Schema.Attribute.String & Schema.Attribute.Unique;
...
export interface ApiRecommendedReadRecommendedRead
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::recommended-read.recommended-read'
    > &
      Schema.Attribute.Private;
    mainContent: Schema.Attribute.RichText &
      Schema.Attribute.Required &
